...
$text1 .= "</td>
	...
	<tr>
        <td style='width:30%' class='button'>";
        if (e_PAGE == "admin_boxmessage.php") {
        $text1 .= "
		<b>
		<a style='cursor:hand; text-decoration:none' href='admin_boxmessage.php'>>> Message Settings <<</a></b>";
        } else {
        $text1 .= "
        <a style='cursor:hand; text-decoration:none' href='admin_boxmessage.php'>Message Settings</a>";}
